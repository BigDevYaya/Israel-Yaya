...
const Service = () => {
  return (
    <section id='services' className=' bg-[#FDF0E9] '>
        <div className='flex items-center justify-center gap-4 flex-col py-7 opacity-0 transition-all duration-1000 ease-in-out translate-y-full' id='service'>
            <p className='uppercase animate-slideIn text-lg text-[#EF6D58] font-medium'>Service</p>
        <h1 className='text-6xl capitalize max-w-md text-center text-[#391400] font-bold'>How can i help you with</h1>

        <div className='grid md:grid-cols-2 grid-cols-1 px-7 mt-5'>
