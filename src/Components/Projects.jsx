...
const Projects = () => {
  return (
    <section className='bg-[#00001a] flex flex-col items-start justify-center gap-4 px-10 py-10'>
        <div className='flex flex-col items-start gap-2 px-10 my-4'> 
        ...
        <div className="flex flex-wrap items-center w-full px-10 mb-4">
            <a className="border p-2 border-[#9B9B9B] relative" href='https://kenpat-college.vercel.app' target='_blank'>
                <img
                src="/school.jpg"
                alt="school"
                className="w-96 h-[30rem] object-cover rounded"
                />
